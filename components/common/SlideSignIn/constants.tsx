export const dataSlideSignIn = [
    ...
    },
    {
        ...
        subtitle: "In a world of repetition, original thought unlocks unparalleled potential.",
        images: [
            {
                animation: "animate-wiggle",
                width: 350,
    ...
    },
    {
        ...
        subtitle: "Embracing evolution propels us forward, making stagnation a memory.",
        images: [
            {
    ...
    },
    {
        ...
        subtitle: "Embrace new knowledge, illuminate your strengths, and ascend to greatness.",
        images: [
            {
