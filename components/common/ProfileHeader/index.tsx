...
export default function ProfileHeader() {
    ...
    return (
        <>
            <div
                className="xl:w-full xl:h-[230px] lg:h-[180px]  flex  items-center justify-center flex-wrap sm:flex-nowrap">
                <div
                    className="xl:w-[700px] xl:h-[230px] lg:w-[500px] lg:h-[180px]  flex justify-start items-center mt-8 sm:mt-0 pl-6 md:pl-0 mb-6 sm:mb-0">
                    <div
                        className="xl:w-[170px] xl:h-[230px] lg:h-[180px]  flex items-center justify-center mr-[0.5rem] ">
                        <div
                            className="xl:w-[170px] xl:h-[150px] lg:w-[130px] lg:h-[120px]  flex items-center justify-center relative">
                            <div
                                className="xl:w-[150px] xl:h-[150px] lg:w-[120px] lg:h-[120px]  w-[100px] sm:h-[100px] bg-[#727272dd] rounded-[50%] overflow-hidden">
                                {profile && (
                                    <Image
                                        src={`${profile?.avatar}`}
                                        style={{
                            ...
                            <div
                                className="xl:w-[60px] xl:h-[25px] xl:text-[15px]  lg:w-[30px] lg:h-[15px] lg:text-[10px] flex justify-center items-center bg-[#014F12] text-[#ffffff] font-bold rounded-[10px] absolute bottom-[20px] right-0 ">
                                PRO
                            </div>
                        </div>
                    </div>
                    <div
                        className="xl:w-[400px] xl:h-[150px] lg:w-[300px] lg:h-[100px]  ml-[1rem] flex flex-col items-start justify-evenly ">
                        ...
                        <div className="w-full xl:h-[50px] lg:h-[30px] flex sm:flex-nowrap items-center flex-wrap">
                            <div
                                className="w-auto h-[24px] sm:xl:h-[35px] lg:h-full flex flex-nowrap items-center mr-[0.5rem] ">
                ...
                <div
                    className="sm:w-[200px] sm:h-[150px] h-[115px] flex sm:flex-col justify-evenly items-center w-full flex-wrap sm:flex-nowrap">
                    <div className="w-[200px] h-[50px] flex items-start justify-between ">
                        <div className="w-[200px] h-[50px] flex justify-evenly items-center ">
                            <div
                                className="w-[40px] h-[40px] cursor-pointer  border-[2px] border-[#6E6E6E] rounded-[10px] flex  items-center justify-center">
                    ...
                    <div className="w-[200px] h-[50px] flex flex-wrap items-start justify-evenly ">
                        <div
                            className="w-[45px] h-[45px]  border-[5px] border-[#6E6E6E] bg-[#ff00004a] rounded-[50%] flex  items-center justify-center">
                            <BsFire fontSize={"24px"} color={"#FF0000"} />
                        </div>
                        <div
                            className="w-[45px] h-[45px]  border-[5px] border-[#6E6E6E] bg-[#9000ff4c] rounded-[50%] flex  items-center justify-center">
                            <AiTwotoneLike fontSize={"24px"} color={"#4D0188"} />
                        </div>
                        <div
                            className="w-[45px] h-[45px]  border-[5px] border-[#6E6E6E] bg-[#ffc8005b] rounded-[50%] flex  items-center justify-center">
