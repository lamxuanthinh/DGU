        ...
        <>
            <div className="w-full h-[65px] flex flex-wrap items-center justify-between">
                <div
                    className={` ${
                        active ? "active" : ""
                    } active:hidden w-[70px] sm:w-[115px] rounded-[5px] h-full items-center sm:justify-center hidden sm:flex`}
                >
                    <Link
                        href="/"
                        className="w-full  rounded-[5px] h-full bg-[#fff] flex items-center justify-center cursor-pointer "
                    >
                        <Image
                ...
                <div
                    className={`${
                        active ? "active" : ""
                    } active:w-full flex items-center justify-end bg-[#fff] rounded-[5px] py-3 px-3 h-[65px] w-full sm:w-[calc(100%-120px)]`}
                >
