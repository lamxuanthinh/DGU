...
function VerifyAuth({ heading, srcImage, description, isVerifySuccess, isVerifyError }: IVerifyAuthProps) {
    return (
        <main className="flex items-center justify-center p-3 min-h-screen animate-falseIn">
            <Button href="/signup" className="fixed top-2 left-2 text-2xl px-4 py-3">
                <BiArrowBack />
            </Button>
            <div className="flex flex-col items-center justify-center gap-y-5">
                <ImageCustom className="max-w-[500px] w-full h-[340px]" src={srcImage} alt="image notification" priority={true} />
                    ...
                    {isVerifySuccess ? (
                        ...
                        <>
                            ...
                            <Button
                                href="/support"
                                type="outline"
                                className="px-10 rounded-[5px] border-[3px] lg:w-[330px] py-3"
                            >
                                Contact Support
                            </Button>
                        </>
