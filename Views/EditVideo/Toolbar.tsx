...
export default function Toolbar() {
  return (
    <div className="grid grid-cols-2 grid-rows-5 gap-4 px-11 py-9 w-[294px] bg-[#1F1F1F] rounded-[15px]">
      <button className="flex flex-col gap-y-1 items-center text-white cursor-pointer">
      ...
      <button className="flex flex-col gap-y-1 items-center text-white cursor-pointer">
        ...
        <span>Delete</span>
      </button> <button className="flex flex-col gap-y-1 items-center text-white cursor-pointer">
