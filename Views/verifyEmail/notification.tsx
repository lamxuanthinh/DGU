...
export default function Notification() {
    ...
    return (
        <VerifyAuth heading="Verify your email" description="Almost there! We've sent a verification email to t****@***.com You need to verify your email address to log into our Vebsite."
